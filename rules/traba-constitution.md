...
- Never deploy without auth in place (`@traba.work` restriction enforced server-side) and a clean compliance check — run the **compliance-check skill** and fix its blockers first. An unprotected deploy is public.
